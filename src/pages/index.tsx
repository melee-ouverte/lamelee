    ...
    <Layout>
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
          Discover, share, and learn from real-world experiences with AI coding assistants 
          like GitHub Copilot, Claude, GPT, and more. Connect with fellow developers and 
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div>
            <div className="text-3xl font-bold text-blue-600">{stats.totalExperiences}</div>
          ...
          <div>
            <div className="text-3xl font-bold text-purple-600">{stats.totalPrompts}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Document your AI coding assistant experiences, including prompts, context, and outcomes.
            </p>
          </div>
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Browse experiences from other developers and learn effective AI prompting techniques.
            </p>
          </div>
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Connect & Discuss</h3>
            <p className="text-gray-600">
              Engage with the community through comments, reactions, and ratings on shared experiences.
            </p>
          </div>
        </div>
      </div>
