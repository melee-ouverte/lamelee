...
export default function PromptRating({ 
  ...
  const StarIcon = ({ filled, interactive = false, onClick, onMouseEnter }: {
    filled: boolean;
    interactive?: boolean;
    onClick?: () => void;
    onMouseEnter?: () => void;
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        {isSubmitting ? (
          ...
          <div className="text-sm text-gray-500">
            {hoveredRating ? `Rate ${hoveredRating} star${hoveredRating !== 1 ? 's' : ''}` : 'Hover to rate'}
          </div>
        )}
      </div>
      ...
      {ratings.length >= 5 && (
        <div className="space-y-2">
          <div className="text-sm font-medium text-gray-700">Rating distribution:</div>
