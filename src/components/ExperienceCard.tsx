...
export default function ExperienceCard({
  ...
  const aiAssistantColor =
    AI_ASSISTANT_COLORS[
      experience.aiAssistant as keyof typeof AI_ASSISTANT_COLORS
    ] || AI_ASSISTANT_COLORS.other;

  return (
    <div
      className={`bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 border border-gray-200 ${className}`}
    >
      {/* Header */}
      <div className="p-6">
        ...
        <div className="flex items-center gap-2 mb-4">
          <span
            className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${aiAssistantColor}`}
          >
